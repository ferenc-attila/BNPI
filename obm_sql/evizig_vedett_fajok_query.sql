...
csak adatot tartalmazó hrsz-ek*/
SELECT evizig_polygons.fid, group_concat(DISTINCT bnpi_species_data.fajnev) AS fajlista
...
AND (bnpi_species_data.datum >= '2010-01-01')
